        ...
        switch ($this->method()) {
            ...
            case 'POST': {
                    return [
                        ...
                        'institution_id' => [Rule::requiredIf(auth()->user()), 'exists:institutions,id'],
                        'matric_no' => [Rule::requiredIf(!auth()->user()),  'bail', 'string', 'max:15', 'min:3'],
                        'dob' =>  'required|string',
                        'level_id' => [Rule::requiredIf(!auth()->user()), 'exists:levels,id'],
                        'programme_id' => [Rule::requiredIf(!auth()->user()), 'exists:programmes,id'],
